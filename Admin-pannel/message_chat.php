...
$dd=mysqli_query($conn,"select DISTINCT messages.outgoing_message_id ,customer_account.fname
FROM messages join customer_account on messages.outgoing_message_id=customer_account.unique_code");
?>
             ...
             while($row=mysqli_fetch_assoc($dd))
                    {
                     ?>
                 <li class="active">
                   <a  href="admin_chat?add_id=<?php echo $row['outgoing_message_id'];?>">
